...
def standardDash(){
	setFont()
	state.dashFormat = ""
	state.dashFormat +="<div><br><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in1a} ${state.in1b} ${state.in1c} $state.fw2</font></font><br></div>"
	state.dashFormat +="<div><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in2a} ${state.in2b} ${state.in2c} $state.fw2</font></font><br></div>"
	state.dashFormat +="<div><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in3a} ${state.in3b} ${state.in3c} $state.fw2</font></font><br></div>"
	state.dashFormat +="<div><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in4a} ${state.in4b} ${state.in4c} $state.fw2</font></font><br></div>"
	state.dashFormat +="<div><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in5a} ${state.in5b} ${state.in5c} $state.fw2</font></font><br></div>"
	state.dashFormat +="<div><font color = $state.fc><font size = $state.fs>$state.fw1 ${state.in6a} ${state.in6b} ${state.in6c} $state.fw2</font></font><br></div>"
