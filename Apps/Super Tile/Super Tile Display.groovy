...
//		section() {input "contactMode1", "bool", title: "Show 'Open' contacts on tile", required: true, defaultValue: false, submitOnChange:true} // soon.....
		section() {
...
def setDone(){
	if(state.line1aVal == " " && state.line1bVal == " " && state.line1cVal == " " || state.line1cVal == null ){state.line1Done = false}
	else{state.line1Done = true}
	if(state.line2aVal == " " && state.line2bVal == " " && state.line2cVal == " " || state.line2cVal == null ){state.line2Done = false}
	...
	if(state.line4aVal == " " && state.line4bVal == " " && state.line4cVal == " " || state.line4cVal == null ){state.line4Done = false}
	else{state.line4Done = true}
	if(state.line5aVal == " " && state.line5bVal == " " && state.line5cVal == " " || state.line5cVal == null ){state.line5Done = false}
	else{state.line5Done = true}
	if(state.line6aVal == " " && state.line6bVal == " " && state.line6cVal == " " || state.line6cVal == null ){state.line6Done = false}
	else{state.line6Done = true}
	if(state.line7aVal == " " && state.line7bVal == " " && state.line7cVal == " " || state.line7cVal == null ){state.line7Done = false}
	else{state.line7Done = true}
	if(state.line8aVal == " " && state.line8bVal == " " && state.line8cVal == " " || state.line8cVal == null ){state.line8Done = false}
