/**
 * 
 *  This is the 'Parent' app for Super Tile
 *
 *
...
def mainPage() {
	...
	section (){app(name: "tileApp", appName: "Super Tile Child", namespace: "Cobra", title: "<b>Add a new child automation</b>", multiple: true)}
	displayDisable()
	}
  }
}
